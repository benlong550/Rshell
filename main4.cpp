...
int main() 
{
    while(1) 
	{
		...
		|| (dPar!=std::string::npos 
            ...
            //int CheckForPrecdence = Input.find('(');
            //dPar!=std::string::npos
            //Separating stuff
            ...
            //This will go through the entire boxes queue and call the createContainer() function to return
            //a cntr representation so that we may push it into our queue<Base*> cmdContainer
	        while(!boxes.empty()) 
			{
